...
const Home = () => {
  return (
    <>
    <div className="flex flex-col items-center px-4 py-8 gap-4 max-w-6xl mx-auto sm:items-start sm:justify-start sm:py-24">
      <div className="flex flex-col items-center sm:flex-row gap-4 sm:justify-between sm:items-start w-full">
        <img src={food} alt="a food photo" className="w-44 sm:order-1 sm:w-4/12 sm:max-w-80 sm:min-w-72 rounded-full shadow-2xl" />
